...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/+8sxRa7yDi7Y0NjJl")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/+8sxRa7yDi7Y0NjJl")
...
async def handle_message(client: Client, message: Message):
    ...
    final_url = f"https://angel-noor-terabox-api.woodmirror.workers.dev/?url={encoded_url}"
    ...
    caption = (
        ...
        "[ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊᴇᴛ-ᴍɪʀʀᴏʀ ❤️🚀](https://t.me/AM_FILMS)"
    )
